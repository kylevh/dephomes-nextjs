...
const styles = {
    navLinks: `${argentum.className} font-light cursor-pointer text-base/2 ml-20 uppercase hover:text-black text-white ease-in-out duration-200`,
    ...
    return (
        <header>
            <nav className='w-full h-24 bg-grey opacity-75 absolute top-0 z-10'>
                ...
                {/* Desktop Menu */}
                <div className='flex items-center justify-between h-full px-6 w-full select-none no-drag unselectable'>
